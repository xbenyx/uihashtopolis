...
export class ChunkService {
  ...
  private endpoint = environment.config.prodApiEndpoint + '/ui/speeds';
 ...
 * @returns  Object
**/
  // getChunks(routerParams?: Params): Observable<> {
  //   let queryParams: Params = {};
  //   if (routerParams) {
  //       queryParams = setParameter(routerParams);
  //   }
  //   return this.http.get<>(this.endpoint,{params: routerParams})
  // }
